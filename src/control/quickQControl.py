...
from devices import devQuickQ


def callQuickQPreset(preset_number: str):
    """Set the QuickQ to a specific preset number."""
    ProgramLog('Setting QuickQ to preset {}'.format(preset_number), 'info')
    devQuickQ.Set('PresetRecall', preset_number)